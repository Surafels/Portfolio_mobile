...
const project = [
  {
    ...
    snapshoot: 'asset/my project.png',
    projectDescription: ' Todo list is an application that enables users to manage activities that they want to do by adding, editing and removing them.',
    description: 'Todo list is an application that enables users to manage activities',
  ...
  <div class="popup-skills">
     <ul class="list-cty">
      ...
      <div class="popup-wrap">
        ...
        <a class="see-bot" href="http://localhost:8081/" name="button">
        See Live
